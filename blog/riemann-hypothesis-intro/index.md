...
*Move the slider to change the upper bound. The plot is drawn live using the same sieve-based algorithm as [`scripts/blog/riemann-hypothesis-intro/prime_counting.py`](scripts/blog/riemann-hypothesis-intro/prime_counting.py).*
...
*Generated by [`scripts/blog/riemann-hypothesis-intro/critical_strip.py`](scripts/blog/riemann-hypothesis-intro/critical_strip.py). Zero heights are the real published imaginary parts of the first ten non-trivial zeros.*
