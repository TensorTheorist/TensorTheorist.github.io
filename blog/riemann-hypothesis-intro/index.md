...
*Move the slider to change the upper bound. The plot is drawn live using the same sieve-based algorithm as [`scripts/riemann/prime_counting.py`](scripts/riemann/prime_counting.py).*
...
*Generated by [`scripts/riemann/critical_strip.py`](scripts/riemann/critical_strip.py). Zero heights are the real published imaginary parts of the first ten non-trivial zeros.*
